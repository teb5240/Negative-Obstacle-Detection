...
for i = 1:length(degrees)
    for j = 1:length(obstacleHeights)
        expectedDistance(j, i) = obstacleHeights(j)/cosd(degrees(i));
    end
end
...
hold on
plot(obstacleHeights, measuredHeights(:,1) + measuredSTD(:,1), '.', 'color', colors(1,:));
plot(obstacleHeights, measuredHeights(:,1) - measuredSTD(:,1), '.', 'color', colors(1,:));
...
hold on
plot(obstacleHeights, measuredHeights(:,2) + measuredSTD(:,2), '.', 'color', colors(2,:));
plot(obstacleHeights, measuredHeights(:,2) - measuredSTD(:,2), '.', 'color', colors(2,:));
...
hold on
plot(obstacleHeights,measuredHeights(:,3) - measuredSTD(:,3), '.', 'color', colors(3,:));
plot(obstacleHeights,measuredHeights(:,3) + measuredSTD(:,3), '.', 'color', colors(3,:));
...
hold on
plot(obstacleHeights, measuredHeights(:,4) + measuredSTD(:,4), '.', 'color', colors(4,:));
plot(obstacleHeights, measuredHeights(:,4) - measuredSTD(:,4), '.', 'color', colors(4,:));
...
hold on
plot(obstacleHeights, measuredHeights(:,5) + measuredSTD(:,5), '.', 'color', colors(5,:));
plot(obstacleHeights, measuredHeights(:,5) - measuredSTD(:,5), '.', 'color', colors(5,:));
...
hold on
plot(obstacleHeights, measuredHeights(:,6) + measuredSTD(:,6), '.', 'color', colors(6,:));
plot(obstacleHeights, measuredHeights(:,6) - measuredSTD(:,6), '.', 'color', colors(6,:));
